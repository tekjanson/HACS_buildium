"""Tests for buildium_IoT api."""
import asyncio

import aiohttp
from custom_components.buildium_iot.api import (
    BuildiumIotApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = BuildiumIotApiClient("test", "test", async_get_clientsession(hass))
